...
class HiraganaToKatakana:
    ...
    def __init__(self, data: Dataset, data_field: str='question', max_words: int=1, pos_tag: str=None):
        ...
        self.name: str = 'hiragana_to_katakana_jp'
    ...
    def apply_on_sample(self, sample: Dict) -> Dict:
        ...
        if not target_indices:
            ...
            for idx in indices_to_perturb:
                ...
                # jaconvで変換
                new_word = jaconv.hira2kata(original_word)
...
if __name__ == "__main__":
    ...
    converter = HiraganaToKatakana(data=DUMMY_DATA, data_field='question', max_words=2)
